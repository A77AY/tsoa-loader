...
import { ValidateModel } from "./../testModel";
...
export class ValidateController {
  ...
  public dateValidate(
    ...
    @Query() maxDateValue: Date
  ): Promise<ValidateDateResponse> {
  ...
  public booleanValidate(
    @Query() boolValue: boolean
  ): Promise<ValidateBooleanResponse> {
    return Promise.resolve({
      boolValue
    });
  }
  ...
  public stringValidate(
    ...
    @Query() patternValue: string
  ): Promise<ValidateStringResponse> {
    return Promise.resolve({
      maxLength,
      minLength,
      patternValue
